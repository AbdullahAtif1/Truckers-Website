        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
           {/* Image Side - African American Driver Portrait */}
            <div className="relative group">
              ...
              />
              <div className="absolute bottom-6 left-6 bg-[var(--bg-card)]/90 backdrop-blur px-6 py-4 border-l-4 border-[var(--primary)] shadow-lg">
                <p className="font-black text-xl uppercase">Marcus "Turbo" King</p>
                <p className="text-sm text-[var(--text-muted)] font-bold">Owner & Lead Operator</p>
              </div>
            </div>
